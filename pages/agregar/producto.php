...
<body class="">
    <section>
        <div class="row align-items-center">
            ...
            <div class="col">
                <h1 class="titleMini ms-0">Nuevo Producto</h1>
            </div>
        </div>
    </section>
    ...
    <section class="pt-4">
        ...
        <form action="/Components/RegistrarProducto.php" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-2">
                <label for="PrincipioActivo" class="mb-0"> <h6 class="NombreComercialCard2">Principio Activo</h6></label>
                <input type="text" class="form-control" name="PrincipioActivo" id="PrincipioActivo">
            </div>
            <div class="mb-2">
                <label for="Laboratorio" class="mb-0"> <h6 class="NombreComercialCard2">Laboratorio</h6></label>
            ...
            <div class="row mb-2">
                ...
                <div class="col">
                    <label for="Caducidad" class="mb-0"> <h6 class="NombreComercialCard2">Caducidad</h6></label>
                    <input type="date" class="form-control" name="Caducidad" id="Caducidad">
                </div>
            </div>
            <div class="mb-2">
                <label for="Imagen" class="mb-0"> <h6 class="NombreComercialCard2">Imagen</h6></label>
                <input type="file" class="form-control" name="Imagen" id="Imagen"  accept="image/*" capture="camera" >
            </div>
            <div class="row mb-2">
                <div class="col">
                    <label for="Gramaje" class="mb-0"> <h6 class="NombreComercialCard2">Gramaje</h6></label>
                    <input type="number" class="form-control" name="Gramaje" id="Gramaje">
                ...
                <div class="col">
                    <label for="Anaquel" class="mb-0"> <h6 class="NombreComercialCard2">Anaquel</h6></label>
                    <input type="text" class="form-control" name="Anaquel" id="Anaquel">
                </div>
            </div>
